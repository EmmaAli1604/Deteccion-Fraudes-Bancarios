...
# deteccion_fraudes_bancarios documentation build
...
from deteccion_fraudes_bancarios import __version__ as release

# -- Project information -----------------------------------------------------

project = "deteccion_fraudes_bancarios"
author = "Kedro"
...
htmlhelp_basename = "deteccion_fraudes_bancariosdoc"
...
latex_documents = [
    (
        master_doc,
        "deteccion_fraudes_bancarios.tex",
        "deteccion_fraudes_bancarios Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "deteccion_fraudes_bancarios",
        "Project deteccion_fraudes_bancarios codebase.",
        "Data-Science",
    )
]
