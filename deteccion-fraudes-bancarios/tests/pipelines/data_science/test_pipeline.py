...
from deteccion_fraudes_bancarios.pipelines.data_science import create_pipeline as create_ds_pipeline
from deteccion_fraudes_bancarios.pipelines.data_science.nodes import split_data
